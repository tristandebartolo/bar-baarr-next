...
import { BlockType, ModeDisplayType } from "./typesOptionsJournal";
...
// export type RegionMinHeightOptionType = {
...
// 	layout_region_min_height: RegionMinHeightOptionType;
...
// // Bloc Articles (carrousel ou liste)
// export interface ArticlesByTermBlock extends BaseBlock {
// 	entity_bundle: "articles_by_term";
// 	field_articles: ArticleReference[];
// 	field_mode_display?: string;
// 	field_template_display?: string;
// 	field_style_image?: string;
...
// export type LayoutBlock = | ArticleBlock | ArticlesBlock | TextBlock | MessageBlock | VideoBlock | AccordionsBlock;
